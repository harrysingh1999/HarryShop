...
export default function Orders() {
  ...
  return (
    <div>
      <h1 className="text-3xl font-semibold md:font-bold md:ms-24 mt-20 md:mt-28 text-center md:text-start">
        My Orders
      </h1>
      {confirmedOrders && auth ? (
          ...
          <div key={crypto.randomUUID()}>
            <div className="mx-3.5 md:mx-8 mt-8 bg-white max-w-7xl px-2 md:px-8 rounded-xl">
              <div className="border-t border-gray-200 py-3 md:py-4 px-2 sm:px-6">
                <h1
                  className="text-base md:text-2xl my-2 md:mb-0 md:mt-1 font-bold md:font-semibold
                   tracking-tight text-gray-900"
                >
                  Thanks for your Order {googleUser.name}!
                </h1>
                <p className="mb-8 text-sm md:text-base font-semibold">
                  {" "}
                  Ordered On: {order.date.slice(0, 25)}
                </p>
              ...
              <div className="border-t border-gray-200 pt-3 pb-5 md:py-6 px-4 sm:px-6">
                ...
                <div className="text-sm md:text-base">
                  ...
                  <p>
                    A-84, Gali No. 4, Pratap Vihar Part-2, Kirari Suleman Nagar,
        ...
        <div className="h-screen w-screen flex flex-col items-center justify-center md:text-2xl bg-red-500 mt-10 px-4">
          <p className="text-white text-center">
            {" "}
            Either you are not Logged In or you haven't purchased any products
            yet.
          </p>
          <NavLink to="/">
