      ...
      >
        ...
        <div className={`${menu} lg:block`}>
          ...
          >
            ...
            <div
              className={`flex flex-col justify-around h-[40%] lg:flex-row lg:justify-around lg:w-[350px] cursor-pointer ${
            ...
            >
              ...
              <div className="flex flex-row items-center gap-4 border-b border-black/30 pb-2 lg:border-none lg:pb-0 lg:gap-0 lg:flex-col lg:justify-center lg:items-center">
